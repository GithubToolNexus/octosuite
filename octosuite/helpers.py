...
class Helper:
    ...
    def search_help_command_table(self):
        ...
        table = self.__create_table(
            table_title="Target Discovery" "\ncommand syntax: `search:<subcommand>`",
            column_headers=["#", "Command", "Description"],
            table_data=[
                (self.__emoji.RIGHT_ARROW, "commits", "Search commits"),
    ...
    def user_help_command_table(self):
        ...
        table = self.__create_table(
            ...
            column_headers=["#", "Command", "Description"],
            table_data=[
                (self.__emoji.EMAIL, "email", "Get a user's email"),
                (self.__emoji.WHITE_QUESTION_MARK, "events", "Get a user's events"),
                (
                    self.__emoji.BUSTS_IN_SILHOUETTE,
                    "followers",
                    "Get a user's followers",
                ),
                (
                    self.__emoji.RIGHT_ARROW,
                    "following",
                    "Get a list of users the target user is following",
                ),
                (
                    self.__emoji.RIGHT_ARROW_CURVING_LEFT,
                    "follows",
                    "Check if target user follows the specified user",
                ),
                (
                    self.__emoji.CARD_FILE_BOX,
                    "gists",
                    "Get a user's gists (shared code snippets)",
                ),
                (
                    self.__emoji.OFFICE_BUILDING,
                    "orgs",
                    "Get organisations that the target user follows/owns",
                ),
                (
                    self.__emoji.IDENTIFICATION_CARD,
                    "profile",
                    "Get a user's profile information",
                ),
                (self.__emoji.FILE_CABINET, "repos", "Get a user's repositories"),
                (
                    self.__emoji.GLOWING_STAR,
                    "subscriptions",
    ...
    def org_help_command_table(self):
        ...
        """
        table = self.__create_table(
            table_title="Organisation Investigation\n"
            ...
            table_data=[
                ...
                (
                    self.__emoji.BUST_IN_SILHOUETTE,
                    "profile",
                    "Get an organisation's profile information",
                ),
                (
                    self.__emoji.FILE_CABINET,
                    "repos",
    ...
    def repo_help_command_table(self):
        ...
        """
        table = self.__create_table(
            table_title="Repository Investigation\n"
            ...
            table_data=[
                ...
                (
                    self.__emoji.EXCLAMATION_QUESTION_MARK,
                    "issues",
                    "Get a repository's issues",
                ),
                (
                    self.__emoji.FILE_FOLDER,
                    "path_contents",
                ...
                (
                    ...
                    "profile",
                    "Get a repository's profile information",
                ),
    ...
    def logs_help_command_table(self):
        ...
        """
        table = self.__create_table(
            table_title="Logs Management\n" "command syntax: `logs:<subcommand>`",
            column_headers=["#", "Command", "Description"],
            table_data=[
                (self.__emoji.LITTER_IN_BIN, "clear", "Clear/Delete all logs"),
    ...
    def csv_help_command_table(self):
        ...
        """
        table = self.__create_table(
            table_title="CSV File Management\n" "command syntax: `csv:<subcommand>`",
            column_headers=["#", "Command", "Description"],
            table_data=[
                (self.__emoji.LITTER_IN_BIN, "clear", "Clear/Delete all csv files"),
    ...
    def help_command(self):
        ...
        The table includes the available commands and their descriptions.
        """
        basic_commands_table = self.__create_table(
            table_title="Basic Commands",
            column_headers=["#", "Command", "Description"],
            table_data=[
                (self.__emoji.WHITE_QUESTION_MARK, "about", "About Octosuite"),
                (self.__emoji.FILE_FOLDER, "cd", "Move to the specified directory"),
                (self.__emoji.LITTER_IN_BIN, "clear", "Clear screen"),
                (self.__emoji.NO_ENTRY, "exit", "Exit/Close session"),
                (self.__emoji.WHITE_QUESTION_MARK, "help", "Show this help menu"),
                (
                    self.__emoji.OPEN_FILE_FOLDER,
                    "ls",
                    "List contents of the current/specified directory",
                ),
                (
                    self.__emoji.UP_BUTTON,
                    "update",
                    "Check for latest program releases/updates",
                ),
            ],
        )
        help_sub_commands = self.__create_table(
            table_title="Investigation & Management Commands\n"
            "command syntax: help:<subcommand>",
            column_headers=["#", "Command", "Description"],
            table_data=[
                (
                    self.__emoji.SPIRAL_NOTEPAD,
                    "csv",
                    "List all csv management commands",
                ),
                (self.__emoji.NOTEBOOK, "logs", "List all logs management commands"),
                (
                    self.__emoji.OFFICE_BUILDING,
                    "org",
                ...
                (
                    self.__emoji.MAGNIFYING_GLASS_LEFT,
                    "search",
