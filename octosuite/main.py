...
class Run:
    ...
    def __call__(self):
        ...
        log.info(message.session_opened(host=system_info['node'], username=CURRENT_USERNAME, timestamp=time.asctime()))
        ...
        xprint(message.session_opened(host=system_info['node'], username=CURRENT_USERNAME, timestamp=time.asctime()))
